...
public class TestingResourceManagerGateway implements ResourceManagerGateway {
	...
	private volatile Function<Tuple5<String, ResourceID, Integer, Integer, HardwareDescription>, CompletableFuture<RegistrationResponse>> registerTaskExecutorFunction;
	...
	public void setRegisterTaskExecutorFunction(Function<Tuple5<String, ResourceID, Integer, Integer, HardwareDescription>, CompletableFuture<RegistrationResponse>> registerTaskExecutorFunction) {
	...
	@Override
	public CompletableFuture<RegistrationResponse> registerTaskExecutor(String taskExecutorAddress, ResourceID resourceId, int dataPort, int proxyPort, HardwareDescription hardwareDescription, Time timeout) {
		final Function<Tuple5<String, ResourceID, Integer, Integer, HardwareDescription>, CompletableFuture<RegistrationResponse>> currentFunction = registerTaskExecutorFunction;

		if (currentFunction != null) {
			return currentFunction.apply(Tuple5.of(taskExecutorAddress, resourceId, dataPort, proxyPort, hardwareDescription));
		} else {
			return CompletableFuture.completedFuture(
