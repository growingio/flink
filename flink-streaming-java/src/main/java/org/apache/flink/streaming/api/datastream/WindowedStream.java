...
public class WindowedStream<T, K, W extends Window> {
    ...
    public <R> SingleOutputStreamOperator<R> reduce(
        ...
        final String opName =
                generateOperatorName(windowAssigner, trigger, evictor, reduceFunction, function);
            ...
            operator =
                    new EvictingWindowOperator<>(
                            ...
                            new InternalIterableProcessWindowFunction<>(
                                    new ReduceApplyProcessWindowFunction<>(
    ...
    public <R> SingleOutputStreamOperator<R> fold(R initialValue, FoldFunction<T, R> function) {
        if (function instanceof RichFunction) {
            throw new UnsupportedOperationException(
                    "FoldFunction can not be a RichFunction. "
    ...
    public <ACC, R> SingleOutputStreamOperator<R> fold(
        ...
        TypeInformation<ACC> foldAccumulatorType =
                TypeExtractor.getFoldReturnTypes(
                        foldFunction, input.getType(), Utils.getCallLocationName(), true);
    ...
    public <ACC, R> SingleOutputStreamOperator<R> fold(
        ...
        if (foldFunction instanceof RichFunction) {
            throw new UnsupportedOperationException(
                    "FoldFunction of fold can not be a RichFunction.");
        }
        if (windowAssigner instanceof MergingWindowAssigner) {
            throw new UnsupportedOperationException(
                    "Fold cannot be used with a merging WindowAssigner.");
        }

        if (windowAssigner instanceof BaseAlignedWindowAssigner) {
            throw new UnsupportedOperationException(
                    "Fold cannot be used with a "
                            + windowAssigner.getClass().getSimpleName()
                            + " assigner.");
        }
        ...
        final String opName =
                generateOperatorName(windowAssigner, trigger, evictor, foldFunction, function);
        KeySelector<T, K> keySel = input.getKeySelector();
        ...
        if (evictor != null) {
            ...
            FoldingStateDescriptor<T, ACC> stateDesc =
                    new FoldingStateDescriptor<>(
                            ...
                            initialValue,
                            foldFunction,
                            foldAccumulatorType.createSerializer(
                                    getExecutionEnvironment().getConfig()));
    ...
    public <R, ACC> SingleOutputStreamOperator<R> fold(
        ...
        TypeInformation<R> windowResultType =
                getProcessWindowFunctionReturnType(
                        windowFunction, foldResultType, Utils.getCallLocationName());
    ...
    public <R, ACC> SingleOutputStreamOperator<R> fold(
        ...
        final String opName =
                generateOperatorName(
                        windowAssigner, trigger, evictor, foldFunction, windowFunction);
        KeySelector<T, K> keySel = input.getKeySelector();
    ...
    public <ACC, R> SingleOutputStreamOperator<R> aggregate(
        ...
        return aggregate(
                function, new PassThroughWindowFunction<K, W, R>(), accumulatorType, resultType);
    }
    ...
    public <ACC, V, R> SingleOutputStreamOperator<R> aggregate(
        ...
        final String opName =
                generateOperatorName(
                        windowAssigner, trigger, evictor, aggregateFunction, windowFunction);
        KeySelector<T, K> keySel = input.getKeySelector();
        ...
        if (evictor != null) {
            ...
            operator =
                    new EvictingWindowOperator<>(
                            ...
                            stateDesc,
                            new InternalIterableWindowFunction<>(
                                    new AggregateApplyWindowFunction<>(
    ...
    private <R> SingleOutputStreamOperator<R> apply(
        ...
        final String opName =
                generateOperatorName(windowAssigner, trigger, evictor, originalFunction, null);
        KeySelector<T, K> keySel = input.getKeySelector();
    ...
    @Deprecated
    public <R> SingleOutputStreamOperator<R> apply(
            R initialValue, FoldFunction<T, R> foldFunction, WindowFunction<R, R, K, W> function) {
    ...
    public <R> SingleOutputStreamOperator<R> apply(
        ...
        if (foldFunction instanceof RichFunction) {
            throw new UnsupportedOperationException(
                    "FoldFunction of apply can not be a RichFunction.");
        }
        if (windowAssigner instanceof MergingWindowAssigner) {
            throw new UnsupportedOperationException(
                    "Fold cannot be used with a merging WindowAssigner.");
        ...
        if (evictor != null) {
            ...
            operator =
                    new EvictingWindowOperator<>(
                            ...
                            new InternalIterableWindowFunction<>(
                                    new FoldApplyWindowFunction<>(
                                            initialValue, foldFunction, function, resultType)),
                            trigger,
                            evictor,
                            allowedLateness,
                            lateDataOutputTag);
            ...
            FoldingStateDescriptor<T, R> stateDesc =
                    new FoldingStateDescriptor<>(
                            "window-contents",
                            initialValue,
                            foldFunction,
